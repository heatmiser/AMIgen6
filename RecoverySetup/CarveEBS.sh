...
ROOTVOLSZ=${ROOTVOLSZ:-6g}
SWAPVOLSZ=${SWAPVOLSZ:-2g}
VARVOLSZ=${VARVOLSZ:-5g}
LOGVOLSZ=${LOGVOLSZ:-2g}
AUDVOLSZ=${AUDVOLSZ:-2g}
HOMEVOLSZ=${HOMEVOLSZ:-2g}
DATAVOLSZ=${DATAVOLSZ:-2g}
...
parted -s ${TARGET} -- mklabel msdos mkpart primary ext4 2048s 100m \
mkpart primary ext4 100m 100%s # set 2 lvm on
...
## done
mkfs.ext4 -L root_disk -q ${TARGET}2 && echo "Formatted ${TARGET}2 with ext4"
